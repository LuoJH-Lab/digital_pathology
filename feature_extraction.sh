...
# nohup python feature_extraction.py --scale 20 --extractor retccl_res50_2048 --outdim 2048 --gpu 1 &> fe_20_retccl.out 
nohup python feature_extraction.py --scale 20 --extractor cTransPath --outdim 768 --gpu 1 &> fe_20_cTransPath.out
# nohup python feature_extraction.py --scale 20 --extractor TCGA_high --outdim 256 --gpu 1 &> fe_20_TCGA_high.out
nohup python feature_extraction.py --scale 20 --extractor TCGA_low --outdim 256 --gpu 1 &> fe_20_TCGA_low.out
nohup python feature_extraction.py --scale 20 --extractor c16_high --outdim 256 --gpu 1 &> fe_20_c16.out
